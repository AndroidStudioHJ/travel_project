...
try:
    ...
    print("Successfully imported scandir from basicsr.utils")
except ImportError as e:
    print("Error importing scandir:", str(e))
    print("Attempting to import from local path...")
    try:
        from ..utils import scandir
        print("Successfully imported scandir from local path")
    except ImportError as e:
        print("Error importing from local path:", str(e))
        raise
